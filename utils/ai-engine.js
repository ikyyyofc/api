...
const SUPPORTED_MIMES = new Set([
    ...
    "video/webm", "video/wmv", "video/3gpp", "audio/wav", "audio/mp3", "audio/aiff",
    "audio/aac", "audio/ogg", "audio/flac", "audio/mpeg", "audio/ogg; codecs=opus",
...
async function chat(messages = [], fileBuffer = null) {
    ...
    const history = messages
        ...
        .map(m => ({
            ...
            parts: typeof m.content === "string" ? [{ text: m.content }] : (m.parts ?? [{ text: "" }])
        }));
    ...
    if (fileBuffer) {
        ...
        const filePart = { inlineData: { mimeType: mimeType, data: base64Data } };
    ...
    const payload = {
        ...
        request: {
            ...
            generationConfig: {
                ...
                temperature: 0.2 // Disesuaikan sedikit agar response relevan untuk koding
            },
